...
docker build -t sles-15.4-clang-builder docker -f docker/sles15.4.dockerfile
...
docker run -i --rm \
    ...
    env -C /tmp $PREFIX/bin/clang++ -std=c++17 -fopenmp /data/test.cpp
    /tmp/a.out
